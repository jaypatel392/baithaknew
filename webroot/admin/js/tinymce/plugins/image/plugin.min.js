...
tinymce.PluginManager.add('image', function(editor, url) {
    function showDialog() {
        ...
        if(imgElm.nodeName == "IMG" && !imgElm.getAttribute('data-mce-object')){
            ...
            if(dom.getAttrib(imgElm, 'style')){
                query_str += "&style=" + dom.getAttrib(imgElm, 'style');
            }
        ...
        function GetTheHtml(){
            ...
            if(imgElm){
                ...
                html += '<input type="hidden" name="style" id="style" value="' + dom.getAttrib(imgElm, "style") + '"/>';
                ...
                html += '<input type="hidden" name="style" id="style" />';
        ...
        function BuildDom(src, alt, w, h, title, linkURL, target, float, class_var, style_var){
            if(imgElm){
                if(src){
