                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input text">
                                ...
                                <input name="brand_name" class="form-control" type="text" id="brand_name" value="<?php echo set_value('brand_name'); ?>" />
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input text">
                                ...
                                <textarea name="brand_description" class="form-control" type="text" id="brand_description" ><?php echo set_value('brand_description'); ?></textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input text">
                                ...
                                <input type="file" name="brand_logo" onchange="checkFiletype(this)">
