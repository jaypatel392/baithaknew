                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <div class="input text">
                                ...
                                <input name="discountmrp_for_dr" onkeyup="changeMsmName(this.value)" class="form-control" type="text" id="discountmrp_for_dr" value="<?php echo set_value('discountmrp_for_dr'); ?>" placeholder="10.00%" />
                        ...
                        <div class="form-group col-md-3">
                            <div class="input text">
                                ...
                                <input type="text" name="discountmrp_for_hospitalist" id="discountmrp_for_hospitalist" value="<?php echo set_value('discountmrp_for_hospitalist'); ?>" placeholder="10.00%"  class="form-control">
                        ...
                        <div class="form-group col-md-3">
                            <div class="input text">
                                ...
                                <input type="text" name="discountmrp_for_pharma_wholseller" id="discountmrp_for_pharma_wholseller" placeholder="10.00%" value="<?php echo set_value('discountmrp_for_pharma_wholseller'); ?>" class="form-control">
                        ...
                        <div class="form-group col-md-3">
                            <div class="input text">
                                ...
                                <input type="text" name="discountmrp_for_chemist" id="discountmrp_for_chemist" value="<?php echo set_value('discountmrp_for_chemist'); ?>" placeholder="10.00%" class="form-control">
