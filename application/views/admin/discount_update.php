<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Discount Update</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Discount Update</h3>
                </div>
            ...
            <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <?php 
                    foreach ($discount_edit as $value)
                    {
                        ?>
                            <!-- /.box-header -->
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <div class="input text">
                                            ...
                                            <input name="discount_name" class="form-control" type="text" id="discount_name" value="<?php echo $value->discount_name; ?>" />
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input text">
                                            ...
                                            <input name="discount_value" class="form-control" type="text" id="discount_value" value="<?php echo $value->discount_value; ?>" />
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input text">
                                            ...
                                            <select name="discount_type" id="discount_type" class="form-control">
                                                <option value=""></option>
                                                <option value="Percent" <?php if($value->discount_type == 'Percent'){ echo "selected"; } ?>>Percent</option>
                                                <option value="Fix" <?php if($value->discount_type == 'Fix'){ echo "selected"; } ?>>Fix</option>
                                            </select>
                                ...
                                <div class="row">  
                                    <div class="form-group col-md-4">                           
                                        ...
                                        <div class='input-group date' id='discount_start_date'>
                                            <input type="text" class="form-control" name="discount_start_date" id="discount_start_date" placeholder="" value="<?php echo $value->discount_start_date; ?>" onkeyup="validate_form_onchange('discount_start_date', this.value)">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class='input-group date' id='discount_end_date'>
                                            <input type="text" class="form-control" name="discount_end_date" id="discount_end_date" placeholder="" value="<?php echo $value->discount_end_date; ?>" onkeyup="validate_form_onchange('discount_end_date', this.value)">
                                            <span class="input-group-addon">
                                                <span class="glyphicon glyphicon-calendar"></span>
                                            </span>
                                        </div>
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="input text">
                                            ...
                                            <select name="discount_status" id="discount_status" class="form-control">
                                                <option value="1" <?php if($value->discount_status == '1'){ echo "selected"; } ?>>Active</option>
                                                <option value="0" <?php if($value->discount_status == '0'){ echo "selected"; } ?>>Deactive</option>
                                            </select>
