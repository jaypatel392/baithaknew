                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="home_deals_url" class="form-control" type="text" id="home_deals_url" value="<?php echo set_value('home_deals_url'); ?>" />
                    ...
                    <div class="row"> 
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <?php echo form_error('home_deals_status','<span class="text-danger">','</span>'); ?>
                            </div>
                        </div>                
                    </div>                   
                </div>
