    ...
    <section class="content-header">
      ...
      Specification<small>Control panel</small>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Specification Update</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Specification Edit</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="specification_name" class="form-control" type="text" id="specification_name" value="<?php echo $value->specification_name; ?>" />
                         ...
                         <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <select name="specification_type" id="specification_status" class="form-control">
                                   <option value=""></option>
                                    <option value="Event" <?php if($value->specification_type == "Event"){ ?> selected <?php } ?> >Event</option>
                                    <option value="Product" <?php if($value->specification_type == "Product"){ ?> selected <?php } ?>>Product</option>
                                </select>
                     ...
                     <div class="row"> 
                    <?php foreach ($specification_value_edit as $speci_value) {
                      # code...
                    ?>
                       ...
                       <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input type="text" name="specification_new_value_<?php echo $speci_value->specification_val_id ?>" value="<?php echo $speci_value->specification_val; ?>" class="form-control">
