    ...
    <section class="content">       
        <div class="box">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Discount Banner Add</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="discount_img_url" class="form-control" type="text" id="discount_img_url" value="<?php echo set_value('discount_img_url'); ?>" />
