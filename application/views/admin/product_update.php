...
<aside class="right-side">
    ...
    <?php foreach ($product_edit as $p_res) 
    {
     ?>
    <!-- Main content -->
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <select name="measurement_type" id="measurement_type" onchange="getAllMsmType(this.value)"  class="form-control">
                                ...
                                {
                                    ?>
                                    <option <?php if($p_res->measurement_id == $msm_res->measurement_id){ echo "selected";} ?> value="<?php echo $msm_res->measurement_id; ?>"><?php echo $msm_res->measurement_name; ?></option>
                                    <?php
                                }
                                ?>                  
                            </select> 
                          ...
                          <span id="msm_value">
                            <?php
                            $msm_array = json_decode($p_res->measurement_value); 
                            for ($i=0; $i < count($msm_array) ; $i++) 
                            {
                            ?>
                              <div class="form-group col-md-3"><div class="input text"><input value="<?php echo $msm_array[$i];?>" required="required" class="form-control" name="measurement_value[]" type="number"></div></div>
                            <?php
                            }
                            ?>
                          </span>
                       ...
                       <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="product_title" class="form-control" type="text" id="product_title" value="<?php echo $p_res->product_title; ?>" />
                            ...
                            <div class="input text">
                               ...
                               <select class="form-control" id="product_shipping_id" name="product_shipping_id">
                                   ...
                                   <?php 
                                        ...
                                        {
                                            ?>
                                            <option <?php if($p_res->product_shipping_id == $s_list->shipping_id){ echo "selected";} ?> value="<?php echo $s_list->shipping_id ; ?>"><?php echo $s_list->shipping_name; ?></option>
                                            <?php
                                        }
                                    ?>
                               </select>
                            ...
                            <div class="input text">
                               ...
                               <select class="form-control" id="product_tax_id" name="product_tax_id">
                                   ...
                                   <?php 
                                        ...
                                        {
                                          if($p_res->product_tax_id == $t_list->tax_id){
                                            $tax_value = $t_list->tax_value;
                                          }
                                            ?>
                                            <option <?php if($p_res->product_tax_id == $t_list->tax_id){ echo "selected";} ?> value="<?php echo $t_list->tax_id ; ?>"><?php echo $t_list->tax_name; ?></option>
                                            <?php
                                        }
                                    ?>
                               </select>
                            ...
                            <div class="input text">
                               ...
                               <select class="form-control" id="product_discount_id" name="product_discount_id">
                                   ...
                                   <?php 
                                        ...
                                        {
                                            ?>
                                            <option <?php if($p_res->product_discount_id == $d_list->discount_id){ echo "selected";} ?> value="<?php echo $d_list->discount_id ; ?>"><?php echo $d_list->discount_name; ?></option>
                                            <?php
                                        }
                                    ?>
                               </select>
                            ...
                            <div class="input text">
                               ...
                               <select class="form-control" id="product_brand_id" name="product_brand_id">
                                   ...
                                   <?php 
                                        ...
                                        {
                                            ?>
                                            <option <?php if($p_res->product_brand_id == $b_list->brand_id){ echo "selected";} ?> value="<?php echo $b_list->brand_id ; ?>"><?php echo $b_list->brand_name; ?></option>
                                            <?php
                                        }
                                    ?>
                               </select>
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                               ...
                               <input type="text" name="product_purchase_price" id="product_purchase_price" placeholder="0.00" value="<?php echo $p_res->product_purchase_price; ?>" class="form-control">
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          <div class="input text" id="sale_price_input">
                                <label>MRP</label>
                               <?php  
                               if($p_res->include_exclude_tax == 'include')
                               {
                                  $product_mrp = round($p_res->product_sale_price+($p_res->product_sale_price * $tax_value)/100);
                                  $dr_price = round($p_res->price_for_doctor+($p_res->price_for_doctor * $tax_value)/100);
                                  $hospitalist_price = round($p_res->price_for_hospitalist+($p_res->price_for_hospitalist * $tax_value)/100);
                                  $chemist_price = round($p_res->price_for_chemist+($p_res->price_for_chemist * $tax_value)/100);
                                  $pharma_price = round($p_res->price_for_pharma+($p_res->price_for_pharma * $tax_value)/100);
                               }
                               else
                               {
                                  $product_mrp = $p_res->product_sale_price;
                                  $dr_price = $p_res->price_for_doctor;
                                  $chemist_price = $p_res->price_for_chemist;
                                  $hospitalist_price = $p_res->price_for_hospitalist;
                                  $pharma_price = $p_res->price_for_pharma;
                               }                            
                               ?>
                               <input type="text" onkeyup="getMrpDiscount(this.value)" name="product_sale_price" value="<?php echo $product_mrp; ?>" id="product_sale_price" placeholder="0.00"  class="form-control">
                        ...
                        <br>
                          <div class="input text">
                                ...
                                <input <?php if($p_res->include_exclude_tax == 'include'){ echo "checked";} ?> type="radio" value="include" id="include_tax" name="include_exclude_tax">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 <label>Excluded Taxes</label>&nbsp;
                                <input type="radio" <?php if($p_res->include_exclude_tax == 'exclude'){ echo "checked";} ?> id="exclude_tax" name="include_exclude_tax" value="exclude">
                          </div>
                        </div>  
                        <div class="form-group col-md-4">
                        <br>
                    ...
                    <div class="row" id="custom_price">
                        <div class="form-group col-md-3" id="custom_price_div">
                           <div class="input text"><label>Price For Dr. <span id="per_for_doctor"></span></label>
                              <input type="text" readonly="readonly" placeholder="0.00" name="price_for_doctor" id="price_for_doctor" value="<?php echo $dr_price; ?>" class="form-control">
                              <span id="error_sale_price" class="text-danger"></span>
                           </div>
                        </div>
                        <div class="form-group col-md-3" id="custom_price_div">
                           <div class="input text">
                               ...
                               <input type="text" readonly="readonly" name="price_for_chemist" placeholder="0.00" id="price_for_chemist" value="<?php echo $chemist_price; ?>" class="form-control"><span id="error_sale_price" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="form-group col-md-3" id="custom_price_div">
                           <div class="input text">
                              <label>Price For Hospitalist <span id="per_for_hospitalist"></span></label>
                              <input type="text" readonly="readonly" placeholder="0.00" name="price_for_hospitalist" id="price_for_hospitalist" value="<?php echo $hospitalist_price; ?>" class="form-control"><span id="error_sale_price" class="text-danger"></span>
                            </div>
                        </div>
                        <div class="form-group col-md-3" id="custom_price_div">
                           <div class="input text">
                              <label>Price For Pharma Wholesaler <span id="per_for_pharma"></span></label>
                              <input type="text" readonly="readonly" placeholder="0.00" name="price_for_pharma" id="price_for_pharma" value="<?php echo $pharma_price; ?>" class="form-control"><span id="error_sale_price" class="text-danger"></span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-4">
                          <div class="input text">
                               ...
                               <input type="number" name="product_qty" id="product_qty" value="<?php echo $p_res->product_qty; ?>" class="form-control" >
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                              ...
                              <select class="form-control" name="product_status" >         
                                  <option <?php if($p_res->product_status == '1'){ echo "selected";} ?> value="1">Active</option>
                                  <option <?php if($p_res->product_status == '0'){ echo "selected";} ?> value="0">Deactive</option>
                              </select>
                      ...
                      <div class="row">                        
                          <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input type="text" class="form-control" id="expiry_date" name="expiry_date" value="<?php echo $p_res->expiry_date; ?>" >
                        ...
                        <div class="form-group col-md-4">
                            <div class="input text">
                               ...
                               <input type="text" name="hsn_code" id="hsn_code" value="<?php echo $p_res->hsn_code; ?>" onchange="checkUnicHsnNumber(this.value,'<?php echo $this->uri->segment(4); ?>')" class="form-control">
                               <span id="error_hsn_code" class="text-danger"></span>
                               <input type="hidden" id="check_unick_hsn">
                            </div>
                        </div> 
                        <div class="form-group col-md-4">
                            <div class="input text">
                                <label>Formula</label>
                               <input type="text" name="product_formula" id="product_formula" value="<?php echo $p_res->product_formula; ?>" class="form-control">
                         ...
                         <div class="form-group col-md-12">
                            <div class="input text">
                                ...
                                <select id="product_img" name="product_img" class="image-picker show-html">          
                                      <option <?php if($p_res->product_thumb_img == base_url().'webroot/product_images/tablate.png'){ echo "selected";} ?> data-img-src="<?php echo base_url()?>webroot/product_images/tablate.png" value="<?php echo base_url()?>webroot/product_images/tablate.png"></option>
                                      <option <?php if($p_res->product_thumb_img == base_url().'webroot/product_images/syrup.jpg'){ echo "selected";} ?> data-img-src="<?php echo base_url()?>webroot/product_images/syrup.jpg" value="<?php echo base_url()?>webroot/product_images/syrup.jpg"></option>
                                      <option <?php if($p_res->product_thumb_img == base_url().'webroot/product_images/injection.png'){ echo "selected";} ?> data-img-src="<?php echo base_url()?>webroot/product_images/injection.png" value="<?php echo base_url()?>webroot/product_images/injection.png"></option>
                                      <option <?php if($p_res->product_thumb_img == base_url().'webroot/product_images/homeopathic.jpg'){ echo "selected";} ?> data-img-src="<?php echo base_url()?>webroot/product_images/homeopathic.jpg" value="<?php echo base_url()?>webroot/product_images/homeopathic.jpg"></option> 
                                      <option <?php if($p_res->product_thumb_img == base_url().'webroot/product_images/others.jpg'){ echo "selected";} ?> data-img-src="<?php echo base_url()?>webroot/product_images/others.jpg" value="<?php echo base_url()?>webroot/product_images/others.jpg"></option>
                                  </select>
                                  </div>
                              </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <div class="input text">
                              ...
                              <textarea class="form-control" rows="6" name="product_description"><?php echo $p_res->product_description;?> </textarea>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
 $("#product_img").imagepicker();
   ...
   function checkUnicHsnNumber(hsn_code,product_id)
   {    
    var dataString = "hsn_code="+hsn_code+'&product_id='+product_id;
     $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/product/checkUnicHsnNumber",         
        data: dataString,
        success: function(response)
        {
           if(response > 0)
          {
            $('#error_hsn_code').html('HSN code is already exists, Please try again!');
            $('#check_unick_hsn').val('1');
            return false;
          }
          else
          {
