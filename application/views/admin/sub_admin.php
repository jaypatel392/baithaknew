                ...
                <div class="pull-right box-tools">
                    ...
                    <?php
                        foreach($getAllTabAsPerRole as $role)
                        {
                            ...
                            {
                                ?>
                                    <a href="<?php echo base_url();?>admin/subAdmin/addSubAdmin" class="btn btn-info btn-sm">Add New</a>              
                                <?php
                            }
                        }
                    ?>                    
...
<tbody>
<?php
    if(!empty($sub_admin_result))
    {
        foreach($sub_admin_result as $res)
        {
            ?>
            <tr>
                ...
                <td width="10%">
                    ...
                    <?php
                        foreach($getAllTabAsPerRole as $role)
                        {
                            ...
                            {
                                ?>
                                    <a href="<?php echo base_url();?>admin/subAdmin/addSubAdmin/<?php echo $res->user_id; ?>" title="Edit"><i class="fa fa-edit fa-2x "></i></a>&nbsp;&nbsp;                
                                <?php
                            }
...
<script type="text/javascript">
    function delete_user(user_id)
    {
        bootbox.confirm("Are you sure you want to delete user details",function(confirmed){
            if(confirmed)
            {
                location.href="<?php echo base_url();?>admin/subAdmin/deleteSubAdmin/"+user_id;
            }
        });
    }    
