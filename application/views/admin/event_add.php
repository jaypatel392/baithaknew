                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <div class="input text">
                                ...
                                <input name="event_title" class="form-control" type="text" id="event_title" value="<?php echo set_value('event_title'); ?>" />
...
var fileUpload = document.getElementById("event_thumb_img");
 ...
 if($('#event_title').val() == '')
    ...
    if(document.getElementById("event_thumb_img").files.length == "")
     {
     ...
     else
     {
       ...
       if(document.getElementById("event_images").files.length == ""){
        $('#error_event_img').html('Event Multiple images is required*');       
        return false;
     }else{ 
        $('#error_event_img').html('');
     }
}
